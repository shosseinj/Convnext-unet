...
$experiment = "one_seed_46_fafem_residual_frequency_guided_deformable_mscb_stage3_warmup_cosine"
$outputName = "46_fafem_residual_frequency_guided_deformable_mscb_stage3_warmup_cosine"
