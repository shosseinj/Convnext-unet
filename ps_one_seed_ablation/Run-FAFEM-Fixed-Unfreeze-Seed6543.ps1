...
$runners = @(
    "12_fafem_fixed_unfreeze.ps1",
    "13_fafem_ugbr_fixed_unfreeze.ps1",
    "14_fafem_dysample_fixed_unfreeze.ps1",
    "15_fafem_gated_skips_fixed_unfreeze.ps1",
    "16_fafem_detail_branch_fixed_unfreeze.ps1",
    "17_fafem_msc_fixed_unfreeze.ps1"
)
...
try {
    foreach ($runnerName in $runners) {
        ...
        Write-Host "[$(Get-Date -Format o)] Fixed-unfreeze seed 6543: $runnerName"
