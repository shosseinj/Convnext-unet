...
$experiment = "one_seed_47_fafem_residual_frequency_guided_deformable_mscb_stage3_full_cosine"
$outputName = "47_fafem_residual_frequency_guided_deformable_mscb_stage3_full_cosine"
...
try {
    & (Join-Path $PSScriptRoot "Invoke-OneSeed-Ablation.ps1") `
        ...
        -MaxGradNorm 1.0 -EarlyStopStartEpoch 160 -EarlyStopPatience 30 `
        -EnableCSAF $false -EnableFAFEM $true `
        ...
        -EnableDeformableResidualFGMSCBLiteStage3 $true `
