...
$experiment = "one_seed_52_fafem_residual_frequency_guided_mscb_stage3_mixstyle12_warmup_cosine"
$outputName = "52_fafem_residual_frequency_guided_mscb_stage3_mixstyle12_warmup_cosine"
...
try {
    & (Join-Path $PSScriptRoot "Invoke-OneSeed-Ablation.ps1") `
        ...
        -EnableLKALiteStage3 $false -EnableMixStyleStage1Stage2 $true `
        -EnableFrequencyAugmentation $false -UncertaintyRefinementVersion none -DryRun:$DryRun
