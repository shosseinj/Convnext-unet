...
def add_ablation_arguments(parser):
    ...
    parser.add_argument("--enable_fg_mscb_lite_stage3", type=parse_bool, default=False)
    parser.add_argument("--enable_residual_fg_mscb_lite_stage3", type=parse_bool, default=False)
